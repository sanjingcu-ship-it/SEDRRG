...
def parse_agrs():
    ...
    parser.add_argument('--sample_diffusion_steps', type=int, default=None, help='number of reverse diffusion steps used only during validation sampling')
    ...
    parser.add_argument('--d_vf', type=int, default=768, help='the dimension of the Swin-V2 patch features.')
