"""
Training entry point for SEDRRG report generation.

This script trains the structured evidence-guided discrete diffusion model
for radiology report generation on IU X-Ray or MIMIC-CXR.
"""
...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='F:\\mimic-cxr-jpg', help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='E:\\szlpythonproject\\727_mimic_report=findings.json', help='the path to the directory containing the data.')
    ...
    parser.add_argument('--sample_temperature', type=float, default=0.6, help='temperature used during diffusion sampling')
